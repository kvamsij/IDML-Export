export const GraphicsMockData = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<idPkg:Graphic xmlns:idPkg="http://ns.adobe.com/AdobeInDesign/idml/1.0/packaging" DOMVersion="8.0">
	...
	<Color Self="Color/JCB Yellow" Model="Spot" Space="CMYK" ColorValue="0 34.99999940395355 94.9999988079071 0" ColorOverride="Normal" SpotInkAliasSpotColorReference="n" AlternateSpace="NoAlternateColor" AlternateColorValue="" Name="JCB Yellow" ColorEditable="true" ColorRemovable="false" Visible="true" SwatchCreatorID="7937" />
	...
	<Color Self="Color/PANTONE 278 C" Model="Process" Space="CMYK" ColorValue="39 14.000000000000002 0 0" ColorOverride="Normal" AlternateSpace="NoAlternateColor" AlternateColorValue="" Name="PANTONE 278 C" ColorEditable="true" ColorRemovable="true" Visible="true" SwatchCreatorID="7937" />
	...
	<Color Self="Color/c100m88y2k0" Model="Process" Space="CMYK" ColorValue="100 87.99999952316284 1.9999999552965164 0" ColorOverride="Normal" AlternateSpace="NoAlternateColor" AlternateColorValue="" Name="c100m88y2k0" ColorEditable="true" ColorRemovable="true" Visible="true" SwatchCreatorID="7937" />
	<Color Self="Color/u7f" Model="Process" Space="CMYK" ColorValue="0 0 0 0" ColorOverride="Normal" AlternateSpace="NoAlternateColor" AlternateColorValue="" Name="$ID/" ColorEditable="true" ColorRemovable="true" Visible="false" SwatchCreatorID="7937" />
	<Color Self="Color/u81" Model="Process" Space="CMYK" ColorValue="0 0 0 100" ColorOverride="Normal" AlternateSpace="NoAlternateColor" AlternateColorValue="" Name="$ID/" ColorEditable="true" ColorRemovable="true" Visible="false" SwatchCreatorID="7937" />
	...
	<Ink Self="Ink/JCB Yellow" Name="JCB Yellow" Angle="45" ConvertToProcess="false" Frequency="70" NeutralDensity="0.34471475368854726" PrintInk="true" TrapOrder="5" InkType="Normal" />
	<PastedSmoothShade Self="PastedSmoothShade/u80" ContentsVersion="0" ContentsType="ConstantShade" SpotColorList="" ContentsEncoding="Ascii64Encoding" ContentsMatrix="1 0 0 1 0 0" Name="$ID/" ColorEditable="true" ColorRemovable="true" Visible="false" SwatchCreatorID="7937">
		<Properties>
	...
	<Gradient Self="Gradient/u7e" Type="Linear" Name="$ID/" ColorEditable="true" ColorRemovable="true" Visible="false" SwatchCreatorID="7937">
		<GradientStop Self="u7eGradientStop0" StopColor="Color/u7f" Location="0" />
		<GradientStop Self="u7eGradientStop1" StopColor="Color/Black" Location="100" Midpoint="50" />
	</Gradient>
